...
BEGIN
  ...
  --visual display
  PROCESS(Clocking, count_r, disp_ena, press, row, column, counter_u, counter_u2, green_m, red_m, blue_m, countR, countL, volleyCount, green_d, red_d, blue_d, green_b, blue_b, red_b)
  ...
  variable hold : integer := 1;
  variable totalCount, color : integer := 0;
  variable count_max : integer := 999999;
  ...
  BEGIN
    ...
    IF(disp_ena = '1') THEN        --display time
		...
		elsif(column < 325 and column > 315) then
